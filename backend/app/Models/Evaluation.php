...
class Evaluation extends Model
{
    ...
    {
        return Evaluation::select(DB::raw("CONCAT(teacher.name, ', ', teacher.last_name) as teacher_name, CONCAT(group.group_code, '*', group.id) as group_code "), 'evaluation.evaluation_name', 'evaluation.ponder', 'subject.subject_name', 'group.id as group_id', 'evaluation.id', 'school.school_name', 'inscription_detail.id as inscription_detail_id')
