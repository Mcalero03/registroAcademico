...
Route::get('/group/byDay/{day}/{teacher}/{classroom}', [GroupController::class, 'byDay']);
...
Route::get('/inscription/showGeneralInscriptions/{card}', [InscriptionController::class, 'showGeneralInscriptions']);
...
Route::get('/attendance/bySubject/{name}/{last_name}/{subject}', [AttendanceController::class, 'bySubject']);
